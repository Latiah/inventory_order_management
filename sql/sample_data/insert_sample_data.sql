...
('Monitor 27 inch',  'Electronics', 219.50,  60,  15,  30),
...
CALL place_order(2, 6, 30);    
CALL place_order(3, 11, 150);  
CALL place_order(4, 8, 2);   
CALL place_order(5, 10, 12);   
CALL place_order(6, 13, 10);
...
CALL start_order(1);
CALL add_item(7, 1, 12);      
CALL add_item(7, 8, 10);       
CALL add_item(7, 9, 2);        
